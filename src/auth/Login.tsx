...
export default function Login() {
  ...
  return (
    <Grid sx={{m:"5rem auto"}} item xs={7} sm={5} md={4} lg={3}>
      <form onSubmit={handleSubmit} style={{ padding:"1rem", border:'2px solid black', margin:"1rem auto", minHeight:"300px", textAlign:"center", display:"flex", flexDirection:"column", gap:"0.5rem"}}>
